...
QUIC transport implementation for [h3](https://github.com/hyperium/h3) based on
[Quinn](https://github.com/quinn-rs/quinn).

## Overview

`h3-quinn` provides the integration between the `h3` HTTP/3 implementation and
the `quinn` QUIC transport library. This creates a fully functional HTTP/3
client and server using Quinn as the underlying QUIC implementation.
...
- [Quinn](https://github.com/quinn-rs/quinn) - The QUIC implementation used by
  this crate
